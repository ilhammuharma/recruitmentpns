...
<?php
	...
	else
	{
		...
		else if(isset($_SESSION['worker']))
		{
			...
			?>
				<h3><strong>Sesuai/Tidak Sesuai MPP</strong></h3>
				<?php
					if($_GET['id']==1)
					{
												...
												while($result = mysql_fetch_array($execFptk))
												{
													?>
														<tr>
															...
															<td><a href="sesuaiMppProcess.php?idFptk=<?php echo $result['idFptk'];?>&approve=<?php echo $_GET['id']?>"><button class="btn btn-primary btn-danger">Klik</button></a></td> 
														</tr>
													<?php
												}
											?>
