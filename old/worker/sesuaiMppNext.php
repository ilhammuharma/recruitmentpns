<?php
	...
	if(isset($_GET['approve']))
	{
		...
		else if($approve==4)
		{
			...
			{
				$updateFptk = "UPDATE fptk SET keteranganPosisi='$keteranganPosisi', namaOdManager='$username', tanggalOdManager='$tanggal' WHERE idFptk='$idFptk'";
			}
		}
		else if($approve==5)
		{
		...
		if($queryFptk)
		{
			echo ("<SCRIPT LANGUAGE='JavaScript'>
					...
					window.location.href='sesuaiMpp.php?id=$approve';
					</SCRIPT>");
		}	
		else
		{
	...
	else if(isset($_POST['submit']))
	{
		...
		$updateFptk = "UPDATE fptk SET mppPosisi='$mppPosisi', keteranganPosisi='$keteranganPosisi', namaOdManager='$username', tanggalOdManager='$tanggal' WHERE idFptk='$idFptk'";
