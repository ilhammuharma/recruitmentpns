										...
										<div class="box-no-border">
											...
											<div class="row">
												...
												<div class="row" class="form-group">
													<div class="col-md-3">
														<div class="table-responsive">
															<h4><strong><label for="permission" class="help-block">Status</label></strong></h4>
														</div>
													</div>
													<?php
														if($_GET['approve']==4)
														...
														{
															?>
															<a href="approvalProcess.php?idFptk=<?php echo $_GET['idFptk']?>&approve=<?php echo $_GET['approve']?>"><button type="submit" onclick="confirmApproval()" class="btn btn-primary btn-sm" name="approval-fptk">Approve</button></a>
															<?php
																if($_GET['approve']==1 or $_GET['approve']==5 or $_GET['approve']==6)
																{
																	?><button type="submit" onclick="TINY.box.show({url:'alasanRejectFptk.php', post:'id=<?php echo $resultFptk['nomorFptk'];?>', width:600,height:300,opacity:20,topsplit:3})" class="btn btn-danger btn-sm" name="approval-fptk">Reject</button><?php 
																} 
																else
																{
																}
