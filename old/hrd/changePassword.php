<?php
	...
	else
	{
		if(isset($_POST['change']))
		{
			...
			$queryCek = "SELECT * FROM loginHrd WHERE username = '$username' and password = '$md5Password'";
			...
			{
				$queryUpdatePassword = "UPDATE loginHrd SET password = '$newMd5Password' WHERE username = '$username'";
