<?php
	...
	if(!isset($_GET['secret']))
	{
		if(isset($_POST['email']))
		{
			...
			$queryReset = "UPDATE loginHrd SET password = '$md5password', resetCode = '', active = 1 WHERE email='$email'";
	...
	else
	{
		...
		$queryCheck = "SELECT * from loginHrd WHERE resetCode = '$secret' and validUntil > '$now'";
						...
						<div class="center">
							...
							<script type="text/javascript">
								function checkPassword()
								{
									...
									{
										message.innerHTML = "Password at least 8 letters.";
									}
									else
									{
										if(npassword != rnpassword)
										{
											message.innerHTML = "The two passwords are not the same.";
