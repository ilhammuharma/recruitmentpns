	...
	else
	{
		if(isset($_SESSION['hrd']))
		{
			...
			if(isset($_POST['submit-post']))
			{
				...
				$queryInput .= "null, '$namaPosisi', '$kodePosisi', $kategoriPosisi, $pendidikanMinimal, $ipkNilai, $umurMaksimal,";
				$queryInput .= "$lokasiPenempatan, $gajiDitawarkan, curdate(),STR_TO_DATE('$batasAkhir', '%d-%m-%Y'), '$kualifikasiLain', $idHrd)";
				//echo $queryInput;
				$execInput = mysql_query($queryInput) or die("SQL ERROR");
				...
				//echo $content;
				$queryInsertSearchLowongan = "INSERT INTO tableSearchLowongan VALUES(null, $idLowongan, '$urlShow', '$content')";
				$execInsertSearchLowongan = mysql_query($queryInsertSearchLowongan) or die("SQL ERROR");
				?>
			...
			else
			{
				?>
					...
					<form action="posting.php" class="form-horizontal" role="form" method="post">
						...
						<div class="form-group">
							<label for="mgpa" class="col-sm-2 control-label">Minimum GPA/Score</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-5">
								<button type="submit" class="btn btn-primary" name="submit-post" id="submit-post">Save</button>
							</div>
						</div>
					</form>
				<?php
