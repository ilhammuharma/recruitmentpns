...
?>
		...
		<form action="asearch.php" role="form" method="get" class="form-horizontal">
			...
			?>
						<option value="<?php echo $provinsi['idProvinsi'];?>"><?php echo $provinsi['namaProvinsi'];?></option>
			<?php
						}
			?>				
					</select>
...
?>
		...
		?>
							<tr>
								...
								<td>
									<a target="_blank" href="<?php echo $webRoot."show/worker.php?id=".$searchResult['idWorker'];?>"><button class="btn btn-sm btn-success">Details</button></a>
								</td>
							</tr>
		<?php
						}
