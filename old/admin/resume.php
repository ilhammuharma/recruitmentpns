	...
	else
	{
		if(isset($_SESSION['admin']))
		{
			...
			if(isset($_POST['saveIdentity']))
			{
				...
				$queryUpdateIdentity = "INSERT INTO userWorker (idWorker, idLogin, namaUser, gender, golonganDarah, tempatLahir, birthday, agama, statusNikah, noKtp,
										kewarganegaraan, noNpwp, emailUser, alamatKtp, alamatSekarang, noPonsel, otherPonsel) 
										VALUES ('', '$idWorker', '$namaLengkap', '$gender', '$golonganDarah', '$tempatLahir', '$birthday', '$agama', '$statusNikah', '$noKtp', 
										'$kewarganegaraan', '$noNpwp', '$email', '$alamatKtp', '$alamatSekarang', '$noPonsel', '$oNoPonsel')";
				$execQuery = mysql_query($queryUpdateIdentity);
				$queryGetIdentity = mysql_fetch_array(mysql_query("SELECT idWorker FROM userWorker order by idWorker desc limit 1"));
				$arrayIdentity['id'] = $queryGetIdentity['idWorker'];
			...
			if(isset($_POST['updateIdentity']))
			{
				...
				$queryUpdateIdentity = "UPDATE userWorker SET namaUser='$namaLengkap', gender='$gender', golonganDarah='$golonganDarah', tempatLahir='$tempatLahir', birthday='$birthday', agama='$agama', statusNikah='$statusNikah', noKtp='$noKtp', 
										kewarganegaraan='$kewarganegaraan', noNpwp='$noNpwp', emailUser='$email', alamatKtp='$alamatKtp', alamatSekarang='$alamatSekarang', noPonsel='$noPonsel', otherPonsel='$onNoPonsel' where idWorker='$idWorker'";
				$execUpdateIdentity = mysql_query($queryUpdateIdentity);
				//echo $queryUpdateIdentity;
				$arrayIdentity['id']=$idWorker;
			}
			...
			if(isset($_POST['saveEdu']))
			{
				...
				//echo $_POST['idWorker'];
				$queryInputEducation = "INSERT INTO pendidikanWorker VALUES('', '$idWorker', '$namaUniversitas', '$alamatUniversitas', '$kualifikasi', '$jurusan', '$ipk', '$lulus')";
			...
			if(isset($_POST['saveExp']))
			{
				...
				$queryInputExp = "INSERT INTO pengalamanWorker VALUES('', '$idWorker', '$pengalaman_perusahaan', '$pengalaman_bidang', '$pengalaman_posisi', 
			...
			if(isset($_POST['saveBhs']))
			{
				...
				$queryInputBahasa = "INSERT INTO skillBahasaWorker VALUES('', '$idWorker', '$bahasa', '$bahasaLisan', '$bahasaMenulis', '$bahasaMembaca', '$bahasaKeterangan')";
			...
			if(isset($_POST['saveSkill']))
			{
				...
				$queryInputSkill = "INSERT INTO skillWorker VALUES('', '$idWorker', '$namaSkill', '$tingkatSkill')";
			...
			if(isset($_POST['saveMengemudi']))
			{
				...
				$queryInputMengemudi = "INSERT INTO skillMengemudiWorker VALUES('', '$idWorker', '$mengemudi', '$keahlianMengemudi', '$noSim')";
			...
			if(isset($_POST['saveTraining']))
			{
				...
				$queryInputTraining = "INSERT INTO skillTrainingWorker VALUES('', '$idWorker', '$namaTraining', '$penyelenggaraTraining', '$tahunTraining', '$keteranganTraining')";
			...
			if(isset($_POST['saveInti']))
			{
				...
				$queryInputInti = "INSERT INTO keluargaInti VALUES('', '$idWorker', '$hubunganInti', '$namaInti', '$genderInti', '$tempatLahirInti',
			...
			if(isset($_POST['saveBesar']))
			{
				...
				$queryInputBesar = "INSERT INTO keluargaBesar VALUES('', $idWorker, '$hubunganBesar', '$namaBesar', '$genderBesar', '$tempatLahirBesar',
			...
			if(isset($_POST['saveDarurat']))
			{
				...
				$queryInputDarurat = "INSERT INTO keluargaDarurat VALUES('', $idWorker, '$hubunganDarurat', '$namaDarurat', '$genderDarurat', '$alamatDarurat',
			...
			if(isset($_POST['saveKenalan']))
			{
				...
				$queryKenalan = "INSERT INTO sosialKenalan VALUES('', '$idWorker', '$namaKenalan', '$perusahaanKenalan', '$jabatanKenalan', '$noTelpKenalan', '$hubunganKenalan')";
			...
			if(isset($_POST['saveReferensi']))
			{
				...
				$queryReferensi = "INSERT INTO sosialReferensi VALUES('', '$idWorker', '$namaReferensi', '$perusahaanReferensi', '$jabatanReferensi', '$noTelpReferensi', '$hubunganReferensi')";
			...
			if(isset($_POST['saveOrganisasi']))
			{
				...
				$queryOrganisasi = "INSERT INTO sosialOrganisasi VALUES('', '$idWorker', '$namaOrganisasi', '$bidangOrganisasi', '$lokasiOrganisasi', '$jabatanOrganisasi', '$tahunOrganisasi')";
			...
			if(isset($_POST['savePsikotest']))
			{
				...
				$queryPsikotest = "INSERT INTO sosialPsikotest VALUES('', '$idWorker', '$waktuPsikotest', '$penyelenggaraPsikotest', '$tempatPsikotest', '$tujuanPsikotest')";
			...
			if(!isset($_GET['id']) AND $arrayIdentity['id'] != '')
			{
				//echo 'a';
				$idWorkerAktif = $arrayIdentity['id'];
				
			}
			else if(!isset($_GET['id']) AND $arrayIdentity['id'] == '')
			{ 
				//echo 'b';
				$idWorkerAktif = '';
			}
			...
			{
				//echo 'c';
				$idWorkerAktif = $_GET['id'];
			}
			$queryGetUser = "SELECT * FROM userWorker WHERE idWorker = '$idWorkerAktif'";
			$execGetUser = mysql_query($queryGetUser);
			$resultGetUser = mysql_fetch_array($execGetUser);
			$idWorker = $resultGetUser['idWorker'];
			...
			//$statusEducation = mysql_fetch_array($execStatusEducation);
			//$idWorker = $statusEducation['idWorker'];
	...
	?>
			...
			<div class="background-tab">
				<ul class="nav nav-tabs nav-justified nav-pills" role="tablist">
					...
					<li id="border-tab" role="presentation"<?php if($tab == "education"){echo " class='active'";}?>><a <?php if($idWorkerAktif==''){}else{echo "href='#pendidikan' role='tab' data-toggle='tab'";}?>>Pendidikan</a></li>
					<li id="border-tab" role="presentation"<?php if($tab == "experience"){echo " class='active'";}?>><a <?php if($idWorkerAktif==''){}else{echo "href='#pengalaman' role='tab' data-toggle='tab'";}?>>Pengalaman</a></li>
					<li id="border-tab" role="presentation"<?php if($tab == "skill"){echo " class='active'";}?>><a <?php if($idWorkerAktif==''){}else{echo "href='#skills' role='tab' data-toggle='tab'";}?>>Skills</a></li>
					<li id="border-tab" role="presentation"<?php if($tab == "lingkunganKeluarga"){echo " class='active'";}?>><a <?php if($idWorkerAktif==''){}else{echo "href='#lingkunganKeluarga' role='tab' data-toggle='tab'";}?>>Lingkungan Keluarga</a></li>
					<li id="border-tab" role="presentation"<?php if($tab == "minat"){echo " class='active'";}?>><a <?php if($idWorkerAktif==''){}else{echo "href='#minat' role='tab' data-toggle='tab'";}?>>Minat Kerja</a></li>
					<li id="border-tab" role="presentation"<?php if($tab == "sosial"){echo " class='active'";}?>><a <?php if($idWorkerAktif==''){}else{echo "href='#sosial' role='tab' data-toggle='tab'";}?>>Aktifitas Sosial</a></li>
				</ul>
			</div>
			...
			<div class="tab-content padding-top-tab">
				...
				<div role="tabpanel" class="tab-pane <?php if($tab == '' || $tab == 'identity'){ echo 'active'; }?>" id="personal">
					<div class="row">
						<div class="col-sm-8">
							<form class="form-horizontal" role="form" action="resume.php#pendidikan" method="post">
								...
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-8">
										<?php if($idWorkerAktif==''){?>
									  <button type="submit" class="btn btn-primary" id="saveIdentity" name="saveIdentity">Simpan</button>
									  <?php }else{?>
										<button type="submit" class="btn btn-primary" id="saveIdentity" name="updateIdentity">Update</button>
									  <?php }?>
									</div>
								</div>
								<?php
					...
					<div id="addEducation" style="display:none!important;">
						<div class="padding-top-under-button row">
							<form class="form-horizontal" role="form" id="formEdu" action="resume.php" method="post">
								<input type="hidden" name="idWorker" value="<?php echo $idWorkerAktif;?>">
									<div class="form-group">
										...
										<div class="col-sm-3">
											...
											<select class="form-control" name="kualifikasi" id="kualifikasi">
												<?php
													...
													{
														?>
															<option value="<?php echo $resultKualifikasi['gradePendidikan'];?>"><?php echo $resultKualifikasi['namaPendidikan'];?></option>
														<?php
													}
												?>
											</select>
										...
										<div class="col-sm-3">
											...
											<select name="jurusan" id="jurusan" class="form-control">
												<?php
													...
													{
														?>
															<option value="<?php echo $resultJurusan['idJurusan'];?>"><?php echo $resultJurusan['namaJurusan'];?></option>
														<?php
													}
												?>
											</select>
											...
											while($resultShowEducation = mysql_fetch_array($execShowEducation))
											{
												?>
													<tr>
														...
														<td><button class="btn btn-xs btn-default" data-toggle="modal" data-target="#education<?php echo $resultShowEducation['idPendidikan'];?>">Edit</button> <button class="btn btn-xs btn-danger" data-toggle="modal" data-target="#delete-edu<?php echo $resultShowEducation['idPendidikan'];?>">Delete</button></td>
													</tr>
													<!-- Modal  EDIT -->
				...
				<div role="tabpanel" class="tab-pane <?php if($tab == 'experience'){ echo 'active'; }?>" id="pengalaman">
					...
					<div id="addExperience" style="display:none!important;" class="row">
						<form class="form-horizontal" role="form" id="formExp" action="resume.php" method="post">
							<input type="hidden" value="<?php echo $idWorkerAktif;?>" name="idWorker">
							<div class="form-group">
					...
					<div id="listExperience" class="show-list row">
						<div class="col-sm-8">
							<?php
								...
								$execShowExperience = mysql_query($queryShowExperience);
								...
								<div class="col-sm-4">
									...
									<select name="bahasa" id="bahasa" class="form-control">
										<?php
											...
											{
												?>
													<option value="<?php echo $resultBahasa['idBahasa'];?>"><?php echo $resultBahasa['namaBahasa'];?></option>
												<?php
											}
										?>
									</select>
								...
								<div class="col-sm-4">
									...
									<select name="bahasa-lisan" id="bahasa-lisan" class="form-control">
										<?php
											...
											{
												?>
													<option value="<?php echo $resultTingkatKeahlian1['gradeKeahlian'];?>"><?php echo $resultTingkatKeahlian1['tingkatKeahlian'];?></option>
												<?php
											}
										?>
									</select>
								...
								<div class="col-sm-4">
									...
									<select name="bahasa-menulis" id="bahasa-menulis" class="form-control">
										<?php
											...
											{
												?>
													<option value="<?php echo $resultTingkatKeahlian2['gradeKeahlian'];?>"><?php echo $resultTingkatKeahlian2['tingkatKeahlian'];?></option>
												<?php
											}
										?>
									</select>
								...
								<div class="col-sm-4">
									...
									<select name="bahasa-membaca" id="bahasa-membaca" class="form-control">
										<?php
											...
											{
												?>
													<option value="<?php echo $resultTingkatAhli3['gradeKeahlian'];?>"><?php echo $resultTingkatAhli3['tingkatKeahlian'];?></option>
												<?php
											}
										?>
									</select>
					...
					<div id="listSkill" class="show-list row">
						<div class="col-sm-8">
							<?php
								...
								$execShowSkill = mysql_query($queryShowSkill);
							?>
							<div class="table-responsive">
								<?php
								...
								<div class="col-sm-4">
									...
									<select name="mengemudi" id="mengemudi" class="form-control">
										<?php
											...
											{
												?>
													<option value="<?php echo $resultMengemudi['idMengemudi'];?>"><?php echo $resultMengemudi['namaMengemudi'];?></option>
												<?php
											}
										?>
									</select>
								...
								<div class="col-sm-4">
									...
									<select name="keahlian-mengemudi" id="keahlian-mengemudi" class="form-control">
										<?php
											...
											{
												?>
													<option value="<?php echo $resultTingkatMengemudi['gradeKeahlian'];?>"><?php echo $resultTingkatMengemudi['tingkatKeahlian'];?></option>
												<?php
											}
										?>
									</select>
								...
								<div class="col-sm-5">
									<select name="keterangan_training" id="keterangan_training<?php echo $resultKetTraining['idTraining'];?>" class="form-control">
										<?php
											...
											{
												?>
													<option value="<?php echo $listKetTraining['idKetTraining']?>" <?php if($listKetTraining['idKetTraining'] == $resultKetTraining['keteranganTraining']){ echo "selected";}?>><?php echo $listKetTraining['tingkatKetTraining'];?></option>
												<?php
											}
										?>
									</select>
					...
					<div id="listTraining" class="show-list row">
						<div class="col-sm-8">
							<?php
								...
								$execShowTraining = mysql_query($queryShowTraining);
							?>
							<div class="table-responsive">
								<?php
						...
						<div class="table-responsive">
							<div class="col-sm-9">
								<?php
									...
									$execShowInti = mysql_query($queryShowInti);
						...
						<div class="table-responsive">
							<div class="col-sm-9">
								<?php
									...
									$execShowBesar = mysql_query($queryShowBesar);
				...
				<div role="tabpanel" class="tab-pane <?php if($tab == 'minat'){ echo 'active'; }?>" id="minat">
						<form class="form-horizontal" role="form" action="resume.php" method="post">
							<input type="hidden" name="id-worker" value="<?php echo $idWorkerAktif;?>">
							<div class="form-group">
			...
			<?php
				include("../worker/templates/foot.php");
		}
