	...
	<?php
					...
					$(document).ready(function(){
						$("#pagination").twbsPagination({
							...
							onPageClick: function(event, page){
								$("#total-worker").load("ajax/get_worker.php",{'page':page}, function(){});
							}
						});
					});
				</script>  
			...
			?>
				...
				<script>
					$('#pagination').twbsPagination({
						...
						visiblePages: 5,
						onPageClick: function (event, page) {
							$("#listLowongan").load("ajax/get_page.php",{'page': page},function(){});
			...
			?>
				...
				<script>
					$('#pagination').twbsPagination({
						...
						visiblePages: 5,
						onPageClick: function (event, page) {
							$("#showArticle").load("ajax/get_article.php",{'page': page},function(){});
		...
		if($title == "slider")
		{
			?>
				<script>
				function show(id){
					$("#show-slider").load("ajax/get-image.php", {'id': id},function(){});
				}
				function showForm(){
					$("#showTambah").show();
				}
			...
			?>
				...
				$(document).ready(function(){
					...
					$('#pagination').twbsPagination({
						...
						visiblePages: 5,
						onPageClick: function (event, page) {
							$("#total-event").load("ajax/get_event.php",{'page': page},function(){});
						}
					});
				});
				</script>
				...
				<script>
					$(document).ready(function(){
						$("#pagination").twbsPagination({
							...
							visiblePages: 5,
							onPageClick: function(event, page){
								$("#total-hrd").load("ajax/get_hrd.php",{'page':page}, function(){});
							}
						});
					});
				</script>
