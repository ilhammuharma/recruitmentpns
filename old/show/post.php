			...
			<div class="container">
				<div class="row">
					<div class="col-md-9">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<?php
									...
									$banyakHari = date_diff($now, $ending);
									$hingga = $ending->format("d M Y");
								?>
								<p><strong>Batas Akhir: <?php echo $hingga;
									if($ending == $now)
									{
										echo " (Hari Ini)";
									}
						...
						<div class="row">
							...
							<div class="col-md-9">
								<p> Minimal Pendidikan: <?php echo $resultShowLowongan['namaPendidikan']." ";?></p>
									<?php
										if($resultShowLowongan['umurMaksimal'] > 0)
										{
											?>
								...
								<p> Penempatan Kerja: <?php echo $resultShowLowongan['namaProvinsi']." ";?></p>
									<?php 
										if($resultShowLowongan['ipkNilai'] > 0 )
										{
											?>
									...
									?>
									<?php 
									if($resultShowLowongan['gajiDitawarkan'] > 0)
									{ 
										?>
						...
						<div class="row">
							<div class="col-md-3">Kualifikasi Lain:</div>
							<div class="col-md-9"><?php echo html_entity_decode($resultShowLowongan['kualifikasiLain']);?></div>
						</div>
						<div class="row">
							<div class="col-md-offset-9 col-md-3" style="color:#FF0000">
							<?php
								if(!isset($_SESSION['username']))
								{
								...
								else
								{
									?>
										<button class="btn btn-success" data-toggle="modal" data-target="#confirm-apply"
											<?php
												$getStatus = "SELECT * FROM applyLowongan WHERE idLowongan = '$id' AND idWorker = '".$_SESSION['idWorker']."'";
										...
										<?php
											if(isset($_SESSION['worker']))
											{
												...
												{
													echo "<p>Anda telah mendafatar lowongan ini</p>";
												}
											}
								}
										?>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title" id="label-confirm">Daftar lowongan kerja</h4>
										</div>
										<div class="modal-body">Apakah Anda yakin ingin mendaftar lowongan ini?</div>
