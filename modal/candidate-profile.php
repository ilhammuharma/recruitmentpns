...
<div class="popdown-content">
	<section class="body">
		<div class="row">
			<div class="col-xs-3">
				<div class="ava">
					<img src="http://career.pratamanusantara.co.id/image/<?=$cet_data['foto']?>" width="200px" alt=""/>
					<div class="caption">
		...
		<div class="row">
			<div class="col-xs-12" >
				...
				<div class="col-xs-4">
					...
					{ ?> <div class="progress"><div class="progress-bar progress-bar-danger" style="width: 50%;">Beginner</div></div> <? }
					else if($cet_lang['lisan']=='Intermediate')
					{ ?> <div class="progress"><div class="progress-bar progress-bar-warning" style="width: 75%;">Intermediate</div></div> <? }
					else
					{ ?> <div class="progress"><div class="progress-bar progress-bar-success" style="width: 100%;">Advanced</div></div> <? }
					?>
		...
		<section class="body">
			...
			<div class="col-xs-4">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" name="gajipokok" class="form-control pokok" id="gajipokok" value="<?=$cet_hr['gajipokok']?>" placeholder="Hanya angka" disabled required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group">
						<div class="input-group-addon">Rp</div>
						<input type="text" name="tunjangan" class="form-control pokok" id="tunjangan" value="<?=$cet_hr['tunjangan']?>" placeholder="Hanya angka" disabled required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group">
						<div class="input-group-addon">Rp</div>
						<input type="text" name="tunjanganlain" class="form-control pokok" id="tunjanganlain" value="<?=$cet_hr['tunjanganlain']?>" placeholder="Hanya angka" disabled required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group">
						<div class="input-group-addon">Rp</div>
						<input type="text" name="premi" class="form-control pokok" id="premi" value="<?=$cet_hr['premi']?>" placeholder="Hanya angka" disabled required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group">
						<div class="input-group-addon">Rp</div>
						<input type="text" name="total" class="form-control total" id="total" value="<?=$cet_hr['total']?>" placeholder="Hanya angka" disabled required>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-4">
				...
				<div class="form-group">
					...
					<div class="input-group">
						<div class="input-group-addon">Rp</div>
						<input type="text" name="makan" class="form-control" id="makan" value="<?=$cet_hr['makan']?>" placeholder="Hanya angka" disabled required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group">
						<div class="input-group-addon">Rp</div>
						<input type="text" name="lembur" class="form-control" id="lembur" value="<?=$cet_hr['lembur']?>" placeholder="Hanya angka" disabled required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group">
						<div class="input-group-addon">Rp</div>
						<input type="text" name="bonus" class="form-control" id="bonus" value="<?=$cet_hr['bonus']?>" placeholder="Hanya angka" disabled required>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-4">
				...
				<div class="form-group">
					...
					<input type="text" name="transport" class="form-control" id="transport" value="<?=$cet_hr['transport']?>" disabled required>
				</div>
				
				<div class="form-group">
					<label for="kesehatan" required="required" class="control-label"><b>Kesehatan</b></label>
					<textarea name="kesehatan" id="kesehatan" style="width:100%; height:100%;" disabled><?=$cet_hr['kesehatan']?></textarea>
				</div>
				
				<div class="form-group">
					<label for="cuti" class="control-label"><b>Cuti</b></label>
					<input type="text" name="cuti" class="form-control" id="cuti" value="<?=$cet_hr['cuti']?>" disabled required>
				</div>
				
				<div class="form-group">
					<label for="dll" required="required" class="control-label"><b>Lain-Lain</b></label>
					<textarea name="dll" id="dll" style="width:100%; height:100%;" disabled><?=$cet_hr['dll']?></textarea>
				</div>
			</div>
			</div>
			...
			<div class="col-xs-4">
				...
				<div class="form-group">
					...
					<div class="input-group">
						<div class="input-group-addon">Rp</div>
						<input type="text" name="expectation" class="form-control" id="expectation" value="<?=$cet_hr['expectation']?>" disabled required>
					</div>
				</div>
			</div>
			</div>
	...
	$verifikasi = mysql_query("select * from vacancyapply where idWorker = '".$id."'");
	$cet_ver = mysql_fetch_array($verifikasi);
	?>
	<section class="body">
		<div class="row">
			<div class="col-xs-12" >
		...
		<div class="row">
			<div class="col-xs-6">
				<table border="0" width="100%" class="print">
					<tr>
						<td width="150px">Sourcing</td>
						<td width="20px">:</td>
						<td>
							<?if($cet_ver['tglsourcing']!='')
							{?><td><?php tanggal2($cet_ver['tglsourcing'])?></td><?}
							else{}
							?>
						</td>
					</tr>
					<tr>
						<td width="150px">Sortlist</td>
						<td width="20px">:</td>
						<td>
							<?if($cet_ver['tglsortlist']!='')
							{?><td><?php tanggal2($cet_ver['tglsortlist'])?></td><?}
							else{}
							?>
						</td>
					</tr>
					<tr>
						<td width="150px">Interview HR</td>
						<td width="20px">:</td>
						<td>
							<?if($cet_ver['tglhr']!='')
							{?><td><?php tanggal2($cet_ver['tglhr'])?></td><?}
							else{}
							?>
						</td>
					</tr>
					<tr>
						<td width="150px">Psikotest</td>
						<td width="20px">:</td>
						<td>
							<?if($cet_ver['tglpsiko']!='')
							{?><td><?php tanggal2($cet_ver['tglpsiko'])?></td><?}
							else{}
							?>
						</td>
					</tr>
					<tr>
						<td width="150px">Interview User</td>
						<td width="20px">:</td>
						<td>
							<?if($cet_ver['tgluser']!='')
							{?><td><?php tanggal2($cet_ver['tgluser'])?></td><?}
							else{}
							?>
						</td>
					</tr>
					<tr>
						<td width="150px">Negotiating Salary</td>
						<td width="20px">:</td>
						<td>
							<?if($cet_ver['tglnego']!='')
							{?><td><?php tanggal2($cet_ver['tglnego'])?></td><?}
							else{}
							?>
						</td>
					</tr>
					<tr>
						<td width="150px">Medical Check-Up</td>
						<td width="20px">:</td>
						<td>
							<?if($cet_ver['tglmcu']!='')
							{?><td><?php tanggal2($cet_ver['tglmcu'])?></td><?}
							else{}
							?>
						</td>
					</tr>
					<tr>
						<td width="150px">Join</td>
						<td width="20px">:</td>
						<td>
							<?if($cet_ver['tgljoin']!='')
							{?><td><?php tanggal2($cet_ver['tgljoin'])?></td><?}
							else{}
							?>
						</td>
					</tr>
