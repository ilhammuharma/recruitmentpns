...
<div class="popdown-content">
	...
	<section class="body">
		<form role="form" id="formpsikotest" action="<?=$base_url?>index.php?r=status-proses" method="post">
			...
			<div class="form-group">
				<label for="rekomendasi" required="required" class="control-label"><b>Rekomendasi User</b></label>
				<label class="radio-inline"><input type="radio" name="rekomendasi" id="sangatdisarankan" value="1">Sangat Disarankan</label>
				<label class="radio-inline"><input type="radio" name="rekomendasi" id="disarankan" value="2">Disarankan</label>
				<label class="radio-inline"><input type="radio" name="rekomendasi" id="dipertimbangkan" value="3">Dipertimbangkan</label>
				<label class="radio-inline"><input type="radio" name="rekomendasi" id="tidakdisarankan" value="4">Tidak Disarankan</label>
			</div>
			<div class="form-group">
				<button type="submit" class="btn btn-primary" id="savepsi" name="savepsi">Save</button>
