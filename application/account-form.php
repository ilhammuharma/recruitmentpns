                                            ...
                                            <div class="col-lg-10">
												<select name="departemen" id="departemen id" class="form-control select2">
													...
													<? 
														...
														{ ?> <option <?=($cet_dep['namaDepartemen']==$data['departemen'])?'selected':'';?> value="<?=$cet_dep['namaDepartemen'] ?>"><? echo $cet_dep['namaDepartemen'] ?></option><? } 
													?>
												</select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-10">
												<select name="distrik" id="distrik" class="form-control select2">
													...
													<? 
														...
														{ ?> <option <?=($cet_distik['namaDistrik']==$data['distrik'])?'selected':'';?> value="<? echo $cet_distik['namaDistrik'] ?>"><? echo $cet_distik['namaDistrik'] ?></option><? } 
													?>
												</select>
                                            </div>
                                        </div>
