<?php
	$kode=$_GET['kode'];
	$kategori=mysql_query("select * from tablemenu where id='$kode'");
	$cet_kat=mysql_fetch_array($kategori);
?> 
			...
			<section class="panel">
				<div class="panel-body">
					<form role="form" action="<?php echo $url ?>index.php?r=menu-proses" method="post">
						<header><h3>Edit Data Menu</h3></header>
						<div class="form-group">
                            <label for="menu">Nama Menu</label>
                            <input type="text" class="form-control" name="menu" value="<? echo $cet_kat['nama_menu'] ?>">
                        </div>
						<div class="clear"></div>
						<div class="form-group">
                            <label for="link">Link</label>
                            <input type="text" class="form-control" name="link" value="<? echo $cet_kat['link'] ?>">
                        </div>
						<div class="clear"></div>
                        <div class="form-group">
						...
						<div class="submit_link">
							<input type="hidden" value="<? echo $kode; ?>" name="id">
							<input type="submit" value="Simpan Perubahan" name="edit" class="btn btn-primary">
