<?
	...
	else
	{
		...
		$list=mysql_query("select nomorFptk from bsm_daily where nomorFptk like '%".$_POST['nomorFptk']."%' $tanggal_sql group by nomorFptk");
		?>
<style>
	.print tr td
	{
    ...
    <div class="row">
		<div class="col-sm-12">
			<section class="panel">
				...
				<table class="table tb-report data-table">
					<thead>
						<tr>
                            <th>
                                OrderDate
