		...
		<div class="col-sm-12">
			<section class="panel">
				...
				<?php
					if($_GET['a']==1)
					{
						/*$getfptk = "Select *, lu.nama from fptk f ";
						$getfptk .= "JOIN loginUser lu ON f.pic = lu.idLogin ";
						$getfptk .= "WHERE namaManager='' AND rejectFptk='' AND (namaPemohon in (select nama from `loginUser` where parent='".$_SESSION['id']."') or namaPemohon='".$_SESSION['nama']."' ) ORDER BY namaPemohon ASC ";*/
						$getfptk = "SELECT * from fptk WHERE namaManager='' AND rejectFptk='' AND (namaPemohon in (select nama from `loginUser` where parent='".$_SESSION['id']."') or namaPemohon='".$_SESSION['nama']."' ) ORDER BY namaPemohon ASC";
						$tombol='approve1';
					}
					else if($_GET['a']==2)
					{
						/*$getfptk = "Select *, lu.nama from fptk f ";
						$getfptk .= "JOIN loginUser lu ON f.pic = lu.idLogin ";
						$getfptk .= "WHERE namaManager!='' AND namaHrdSuperintendent='' AND rejectFptk='' ORDER BY namaPemohon ASC ";*/
					...
					else if($_GET['a']==3)
					{
						/*$getfptk = "Select *, lu.nama from fptk f ";
						$getfptk .= "JOIN loginUser lu ON f.pic = lu.idLogin ";
						$getfptk .= "WHERE namaHrdSuperintendent!='' AND namaGeneralManager='' AND rejectFptk='' ORDER BY namaPemohon ASC ";*/
					...
					else if($_GET['a']==4)
					{
						/*$getfptk = "Select *, lu.nama from fptk f ";
						$getfptk .= "JOIN loginUser lu ON f.pic = lu.idLogin ";
						$getfptk .= "WHERE namaGeneralManager!='' AND namaOdManager='' AND rejectFptk='' ORDER BY namaPemohon ASC ";*/
					...
					else if($_GET['a']==5)
					{
						/*$getfptk = "Select *, lu.nama from fptk f ";
						$getfptk .= "JOIN loginUser lu ON f.pic = lu.idLogin ";
						$getfptk .= "WHERE namaOdManager!='' AND namaHrdManager='' AND rejectFptk='' ORDER BY namaPemohon ASC ";*/
					...
					else if($_GET['a']==6)
					{
						/*$getfptk = "Select *, lu.nama from fptk f ";
						$getfptk .= "JOIN loginUser lu ON f.pic = lu.idLogin ";
						$getfptk .= "WHERE namaHrdManager!='' AND namaDirektur='' AND rejectFptk='' ORDER BY namaPemohon ASC ";*/
					...
					else if($_GET['a']==7)
					{
						/*$getfptk = "Select *, lu.nama from fptk f ";
						$getfptk .= "JOIN loginUser lu ON f.pic = lu.idLogin ";
						$getfptk .= "WHERE namaDirektur!='' AND namaRecruitmentSuperintendent='' AND rejectFptk='' ORDER BY namaPemohon ASC ";*/
					...
					else
					{
						/*$getfptk = "Select *, lu.nama from fptk f ";
						$getfptk .= "JOIN loginUser lu ON f.pic = lu.idLogin ";
						$getfptk .= "WHERE namaRecruitmentSuperintendent!='' AND closingby='' AND rejectFptk='' ORDER BY namaPemohon ASC";*/
