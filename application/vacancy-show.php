	...
	<?while($cet_ven = mysql_fetch_array($execkategori)){?>
		<div class="panel-body">
			...
			<div class="row">
				<div class="col-xs-12">
					<table border="0" width="100%" class="print">
						<tr><td><?php echo $cet_ven['other'];?></td></tr>
					</table>
				</div>
			</div>
			<br/>
			...
			<div class="row">
				<div class="col-xs-12">
					<table border="0" width="100%" class="print">
						<tr><td><?php echo $cet_ven['jobdes'];?></td></tr>
					</table>
				</div>
			</div>
			<br/>
			...
			<section class="isolate-tabs">
				<ul class="nav nav-tabs">
					<li class="active"><a data-toggle="tab" href="<?=$base_url?>index.php?r=vacancy-show#sourcing-iso">Sourcing</a></li>
					<li class=""><a data-toggle="tab" href="<?=$base_url?>index.php?r=vacancy-show#sortlist-iso">Sortlist</a></li>
					<li class=""><a data-toggle="tab" href="<?=$base_url?>index.php?r=vacancy-show#interviewhr-iso">Interview HR</a></li>
					<li class=""><a data-toggle="tab" href="<?=$base_url?>index.php?r=vacancy-show#psikotest-iso">Psikotest</a></li>
					<li class=""><a data-toggle="tab" href="<?=$base_url?>index.php?r=vacancy-show#interviewuser-iso">Interview User</a></li>
					<li class=""><a data-toggle="tab" href="<?=$base_url?>index.php?r=vacancy-show#negotiatingsalary-iso">Negotiating Salary</a></li>
					<li class=""><a data-toggle="tab" href="<?=$base_url?>index.php?r=vacancy-show#mcu-iso">Medical Check-Up</a></li>
					<li class=""><a data-toggle="tab" href="<?=$base_url?>index.php?r=vacancy-show#join-iso">Join/Reject</a></li>
				</ul>
												...
												<tr> 
													...
													<td align="center">
														...
														{ 
															?><a class="btn btn-success btn-xs" href="modal/candidate-profile.php?id=<?=$cet_kandidat['idWorker']?>" data-toggle="modal" data-target="#candidate<?=$cet_kandidat['idWorker']?>"><i class="fa fa-eye"></i></a>
															<div id="candidate<?=$cet_kandidat['idWorker']?>" class="modal fade"><div class="modal-dialog" style="width:90%;"><div class="modal-content"></div></div></div><?
															?><a class="btn btn-primary btn-xs" href="modal/status-sortlist.php?id=<?=$cet_kandidat['idWorker']?>&v=<?=$idvacancy?>" data-toggle="modal" data-target="#sortlist<?=$cet_kandidat['idWorker']?>"><i class="fa fa-pencil"></i></a>
															<div id="sortlist<?=$cet_kandidat['idWorker']?>" class="modal fade" ><div class="modal-dialog" style="width:auto;"><div class="modal-content"></div></div></div><?
														}*/
														?>
														<!--<a class="btn btn-success btn-xs" href="<?=$base_url?>index.php?r=status-viewhr&id=<?=$cet_kandidat['idWorker']?>"><i class="fa fa-eye"></i></a>-->
														<!--<a class="btn btn-primary btn-xs" href="<?=$base_url?>index.php?r=status-interviewhr"><i class="fa fa-plus"></i></a>-->
										...
										<form method="post" action="<?=$base_url?>index.php?r=status-proses">
											...
											while($cet_vacancy=mysql_fetch_array($execvacancy))
											{
												...
												<tr> 
													...
													<td align="center">
														<? if($cet_vacancy['joinreject']!='' and $cet_vacancy['joindate']!='') 
														{ 
															?><a class="btn btn-success btn-xs" href="modal/candidate-profile.php?id=<?=$cet_kandidat['idWorker']?>" data-toggle="modal" data-target="#candidate<?=$cet_kandidat['idWorker']?>"><i class="fa fa-eye"></i></a>
															<div id="candidate<?=$cet_kandidat['idWorker']?>" class="modal fade"><div class="modal-dialog" style="width:90%;"><div class="modal-content"></div></div></div><?
															?><!--<a class="btn btn-primary btn-xs" href="modal/status-viewuser.php?id=<?=$cet_kandidat['idWorker']?>" data-toggle="modal" data-target="#viewuser<?=$cet_kandidat['idWorker']?>"><i class="fa fa-eye"></i></a>
														...
														{ 
															?><a class="btn btn-success btn-xs" href="modal/candidate-profile.php?id=<?=$cet_kandidat['idWorker']?>" data-toggle="modal" data-target="#candidate<?=$cet_kandidat['idWorker']?>"><i class="fa fa-eye"></i></a>
															<div id="candidate<?=$cet_kandidat['idWorker']?>" class="modal fade"><div class="modal-dialog" style="width:90%;"><div class="modal-content"></div></div></div><?
															?><a class="btn btn-primary btn-xs" href="modal/status-join.php?id=<?=$cet_kandidat['idWorker']?>&v=<?=$idvacancy?>" data-toggle="modal" data-target="#join<?=$cet_kandidat['idWorker']?>"><i class="fa fa-pencil"></i></a>
															<div id="join<?=$cet_kandidat['idWorker']?>" class="modal fade" ><div class="modal-dialog" style="width:90%;"><div class="modal-content"></div></div></div><?
														}
														?>
													</td>
												</tr>
