...
<body class="sticky-header">
    ...
    <section>
        ...
        <!-- body content start-->
        <div class="body-content" style="min-height: 1250px;">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="pull-left">
                                    ...
                                    <a href="invoice.html#" class="btn btn-success">Generate PDF</a>
                                </div>
                                <div class="pull-right">
                                    <a href="invoice.html#" class="btn btn-success">Submit Payment</a>
                                </div>
                            </div>
            ...
            <ul class="nav nav-tabs nav-justified-">
                <li class="active">
                    <a href="invoice.html#chat" data-toggle="tab">Chat</a>
                </li>
                <li class="">
                    <a href="invoice.html#info" data-toggle="tab">Info</a>
                </li>
                <li class="">
                    <a href="invoice.html#settings" data-toggle="tab">Settings</a>
                </li>
            </ul>
                ...
                <div class="online-chat">
                    <div class="online-chat-container">
                        <div class="chat-list">
                            ...
                            <a href="invoice.html#" class="add-people tooltips" data-original-title="Add People" data-toggle="tooltip" data-placement="left">
            ...
            <div class="chat-list info">
                ...
                <a href="invoice.html#" class="add-people tooltips" data-original-title="Refresh" data-toggle="tooltip" data-placement="left">
            ...
            <div class="aside-widget">
                <div class="side-title-alt">
                    <h2>Revenue</h2>
                    <a href="invoice.html#" class="close side-w-close">
