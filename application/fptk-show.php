									...
									<table class="table table-striped table-hover">
										...
										?>
											<tr>
												...
												<td align="center"><a class="btn btn-success btn-xs" href="modal/candidate-profile.php?id=<?=$cet_sortlist['idWorker']?>" data-toggle="modal" data-target="#candidate<?=$cet_sortlist['idWorker']?>"><i class="fa fa-eye"></i></a>
												<div id="candidate<?=$cet_sortlist['idWorker']?>" class="modal fade"><div class="modal-dialog" style="width:90%;"><div class="modal-content"></div></div></div></td>
											</tr>
										<?}?>
										</tbody>
									</table>
