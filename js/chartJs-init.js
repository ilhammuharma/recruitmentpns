...
(function(){
    ...
    function redraw(animation){
        ...
        var barChartData = {
            labels : ["January","February","March","April","May","June","July","Augst","September","October","November","December"],
            datasets : [
                {
                    fillColor : "#4EC9B4",
                    strokeColor : "#4EC9B4",
                    data : [43,54,95,71,66,45,70,22,42,12,34,90]
                },
                {
                    fillColor : "#868BB8",
                    strokeColor : "#868BB8",
                    data : [38,80,50,29,96,37,100,92,34,12,87,34]
                }
            ]
